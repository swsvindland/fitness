...
let rootUrl = URL(string: "https://beta.workout-track.com")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["beta.workout-track.com"]

// auth origins will open in modal and show toolbar for back into the main origin.
// These should also appear in Info.plist
let authOrigins: [String] = ["clerk.workout-track.com", "accounts.workout-track.com", "accounts.google.com", "appleid.apple.com"]
