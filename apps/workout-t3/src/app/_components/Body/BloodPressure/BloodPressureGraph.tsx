      ...
      datasets: [
        {
          label: "Systolic",
          data:
            userBloodPressureQuery.data?.data.map((item) => item.systolic) ??
            [],
        ...
        },
        {
          label: "Diastolic",
          data:
            userBloodPressureQuery.data?.data.map((item) => item.diastolic) ??
            [],
  ...
  return (
    <div className="card w-full rounded p-4 shadow">
      <div className="flex flex-row">
        ...
        <LinkSecondaryButton to="body/blood-pressure">Add</LinkSecondaryButton>
      </div>
