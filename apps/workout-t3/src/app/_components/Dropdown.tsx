            ...
            {({ open }) => (
                <div className={className}>
                    ...
                    <div className="relative mt-1" id={id}>
                        <Listbox.Button className="border-ternary bg-background focus:border-secondary focus:ring-secondary relative w-full cursor-default rounded-md border py-2 pl-3 pr-10 text-left shadow-sm focus:outline-none focus:ring-1 sm:text-sm">
